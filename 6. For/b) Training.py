...
# Erstelle eine Liste mit allen Primzahlen zwischen 10 und 30, speicher diese
# Liste in einer Variablen und gib jedes einzelne Element der Liste mit der
# print() Funktion im Terminal aus. Nutze dazu For Schleifen.
...
# diese deiner Liste hinzu. Gebe die Liste am Ende im Terminal mit der print() Funktion aus.
